...
- [ ] Run tests: `pytest tests/unit/cli/test_app.py -v` - all fail ✓
...
- [ ] Run tests: `pytest tests/unit/cli/test_app.py -v` - all pass ✓
...
- [ ] Run tests: `pytest tests/unit/cli/test_output.py -v` - all pass ✓
...
- Example: `[green]✓[/green] Story created successfully`
...
- ✅ Typer app initialized and tests pass
- ✅ --version and --help flags work correctly
- ✅ --json flag toggles output mode globally
- ✅ OutputFormatter supports both rich and JSON rendering
- ✅ Entry point works via `uvx`, `pipx`, and `python -m`
- ✅ Code coverage >90%
